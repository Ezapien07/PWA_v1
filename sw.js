//Definir el arreglo CHACHE_ELEMENTS con todas las rutas de los archivos a aguardar en el cache
...
//es chacear todas las rutas para que ahora el service worker me provea de 
//toda esa información y ya no tenga que estar haciendo peticiones a internet 
//a cada rato 
...
/*Trabajando con el siguiente evento del service worker llamado fetch,
 es el evento que se va a disparar cada que nosotros abramos el sitio,
  por ejemplo, lo que va a hacer buscará una nueva versión de nuestros
   ...
   activado. En caso de que se vaya a crear una nueva habra que hacer
    la petición y respondernos una nueva cosa.
    */
